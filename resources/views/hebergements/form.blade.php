                        ...
                        <div class="row ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="custom-select" name="participant_id"  required>
                                        @foreach($participants as $participant)
                                            <option value="{{$participant->id}}" @if($participant->id == $hebergement->participant_id) selected @endif>{{$participant->nom_par.' '.$participant->prenom_par}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <select class="custom-select" name="site_heberg"  required>
                                        @foreach($site_heberg as $siteheberg)
                                            <option value="{{$siteheberg}}" @if($siteheberg=='Atlas Sky Airport') selected @endif>{{$siteheberg}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="form-column">
                                <div class="form-group row ">
                                    ...
                                    <input type="datetime-local" class="custom-select" name="date_checkin">
                                </div>
                                <div class="form-group row ">
                                    <label for="date_checkout"  class="font-weight-bold " >Date Check out:</label><br>
                                    <input type="datetime-local" class="custom-select" name="date_checkout">
                                </div>
                            </div>
                        </div>
                    </div>
