                    ...
                    <div class="row ">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" class="custom-select" name="tel"
                                       @if($volontaire->tel) value={{old('tel',$volontaire->tel)}}  @endif>
                            </div>
                                    ...
                                    @foreach($participants as $participant)
                                        @if($participant->categorie->id==1)
                                            <option value="{{$participant->id}}"
                                                    @if($participant->id == $volontaire->participant_id) selected @endif>
                                ...
                                <select class="custom-select" name="site_aff" required>
                                    @foreach($site_aff as $siteaff)
                                        <option value="{{$siteaff}}"
                                                @if($siteaff==$volontaire->site_aff) selected @endif>{{$siteaff}}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-column">
                            ...
                            <div class="form-group row ">
                                ...
                                <input type="date" class="custom-select" name="fin_contrat"
                                       @if($volontaire->fin_contrat) value={{old('fin_contrat',$volontaire->fin_contrat)}} @else value="{{date("2025-m-d")}}" @endif>
                            </div>
                        </div>
                    </div>
                </div>
