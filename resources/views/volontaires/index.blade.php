            ...
            <table class="table table-borderless table-bordered table-hover w-100 mt-2 shadow-lg mb-5 bg-white rounded  ">
                ...
                @foreach($volontaires as $volontaire)
                    <tr class="text-center">
                        ...
                        <td>
                            <a  class="btn btn-outline-primary rounded-6 mr-2" data-toggle="tooltip" data-placement="top" title="Consulter" href="{{route('volontaires.show',$volontaire->id)}}" ><i class="fas fa-address-card"></i></a>
                            <a  class="btn btn-outline-warning rounded-6 mr-2 create-volontaire" data-toggle="tooltip" data-placement="top" title="Modifier" href="{{route('volontaires.edit',$volontaire->id)}}" ><i class="fas fa-edit"></i></a>
                            <a  class="btn btn-outline-danger rounded-6 mr-2 delete-elm"  data-toggle="tooltip" data-placement="top" title="Supprimer" href="{{route('volontaires.delete',$volontaire->id)}}" ><i class="fas fa-trash"></i></a>
