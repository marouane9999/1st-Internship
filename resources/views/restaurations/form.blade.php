                    ...
                    <div class="modal-body p-5">
                        <div class="row ">
                            <div class="col-sm-12">
                                ...
                                <input type="number" class="form-control" id="numero_rest"  placeholder="Numéro de restauration" name="numero_rest">
                            </div>
                                <div class="form-group row">
                                    ...
                                    <select class="custom-select" name="site_restau"  required>
                                        @foreach($site_restau as $siterestau)
                                            <option value="{{$siterestau}}" @if($siterestau=='AGORA BEACH') selected @endif>{{$siterestau}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="search" class="form-control" id="prestataire" placeholder="Prestataire" name="prestataire">
                                </div>
                                <div class=" form-group row">
                                    <label for="rep_id"  class="font-weight-bold" name="rep_id">Catégorie de repas:</label><br>
                                    <select class="custom-select" name="rep_id" required>
                                        @foreach($repas as $rep)
                                            <option value="{{$rep->id}}" @if($rep->id==$restauration->rep_id) selected @endif>{{ucfirst($rep->des_rep)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class=" form-group row">
                                    ...
                                    <select class="custom-select" name="participant_id"  required>
                                        @foreach($participants as $participant)
                                            <option value="{{$participant->id}}" @if($participant->id == $restauration->participant_id) selected @endif>{{$participant->nom_par.' '.$participant->prenom_par}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
